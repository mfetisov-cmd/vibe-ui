...
const Icon = ({
  ...
  return (
    <Box
      ...
      {...rest}
    >
      <path d="m8.707 16.707 8-8-1.414-1.414-8 8zM9 10.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3M16.5 15a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0" />
      <path
        clipRule="evenodd"
...
export const Taxes24 = createPolymorphicComponent<'svg', SquareIconProps>(Icon);
