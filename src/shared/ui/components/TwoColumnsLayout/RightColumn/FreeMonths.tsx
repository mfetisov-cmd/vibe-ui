...
export const FreeMonths = () => {
  const t = useTranslations('onboarding.right_column.free_months');
  ...
  return (
    <StyledBox>
      <StyledImage
        alt=""
        height={400}
        src="/images/right_column/free_months_number.webp"
        unoptimized
        width={400}
      />
      <Row maxWidth={theme.token.sizeUnits(205)}>
        <Typography align="center" color={theme.token.color.c18} variant="h4">
          {t.rich('title', {
            highlight: (chunks) => <HighlightText>{chunks}</HighlightText>,
          })}
        </Typography>
      </Row>
    </StyledBox>
